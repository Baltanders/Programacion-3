...
?>	
	...
	<form name="frmModificar" method="POST" action="Alta.php" >
		<input type="text" name="idparamodificar" id="idparamodificar" hidden/>
	</form>
...
//
		...
		echo " 	<tr>
					...
					<td><button class='btn btn-warning' name='Modificar' onclick='Modificar($cd->id)'>Modificar</button></td>
					<td>$cd->cantante</td>
					<td>$cd->año</td>
					<td>$cd->titulo</td>
				</tr>";
